<!-- Logout Modal-->
<div class="modal fade" id="inspector-list" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-borderless d-flex justify-content- flex-column" id="inspectorModalTable" width="100%" cellspacing="0">
                    <thead>
                    ...
                    <tbody class="w-100">
                        ...
                        ?>
                            <tr class="d-flex justify-content-between align-inspectors-center border-bottom py-1 select-certificate-inspector" data-inspector-id="<?php echo $inspector['inspector_id'] ?>">
                                <td class="p-0 m-0 w-100">
                                    ...
                                    text-gray-700 flex-gap w-100">
                                        <div class="image-container img-fluid">
                                            <img src="<?php echo SITEURL ?>inspection/inspector/images/<?php echo $inspector['inspector_img_url'] ?? 'default.png' ?>" alt="inspector-image" class="img-fluid rounded-circle" />
                                        </div>
