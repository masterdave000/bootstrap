<!-- Logout Modal-->
<div class="modal fade" id="deleteModal-<?php echo $billing['bldg_billing_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="./controller/delete.php" method="POST">
                <div class="modal-body">Select "Delete" below if you are ready to delete the building billing record.
                    <div class="d-flex justify-content-center">
                        <div class="d-flex flex-column">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="bldg_billing_id" value="<?php echo $billing['bldg_billing_id'] ?>" />
                            </div>
                        </div>
                    </div>
                </div>
