                                ...
                                ?>
                                    ...
                                    <tr class="d-flex justify-content-between align-items-center border-bottom py-1">
                                            ...
                                            <a href="view-billing.php?bldg_billing_id=<?php echo $billing['bldg_billing_id'] ?>" class="d-flex flex-row align-items-center text-decoration-none text-gray-700 flex-gap">
                                                <div>
                                                    ...
                                                    <div class="sub-title d-none d-md-flex">Property:
                                                        <?php echo $billing['bldg_property_attribute'] ?>
                                                    </div>
                                                </div>
                                            </a>
                                        </td>
                                        ...
                                        <td class="d-flex justify-content-end">
                                            <a href="./update-billing.php?bldg_billing_id=<?php echo $billing['bldg_billing_id'] ?>" class="btn btn-info mr-2 text-center d-flex align-items-center">
                                                <i class="fa fa-pencil-square mr-1" aria-hidden="true"></i>
                                                <span class="d-none d-lg-inline">Edit</span>
                                            </a>

                                            <a href="#" data-bs-toggle="modal" data-bs-target="#deleteModal-<?php echo $billing['bldg_billing_id'] ?>" class="btn btn-danger d-flex justify-content-center align-items-center">
