<!-- Logout Modal-->
<div class="modal fade" id="deleteModal-<?php echo $billing['electronics_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="d-flex flex-column">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="electronics_id" value="<?php echo $billing['electronics_id'] ?>" />
                            </div>
                        </div>
                    </div>
                </div>
