                        ...
                        <form action="./controller/update.php" method="POST" class="user" enctype="multipart/form-data">
                            ...
                            <div class="d-md-flex align-items-center justify-content-center flex-gap">
                                ...
                                <div class="col col-md-6 p-1 form-group flex-md-grow-1">
                                    ...
                                    <input type="text" name="inspector_midname" id="inspector-midname" class="form-control p-4" id="exampleInputOwnerName" aria-describedby="inspectorNameHelp" placeholder="Enter Middle Name..." pattern="[a-zA-z -.ñÑ]+" oninvalid="this.setCustomValidity('Numbers and Special Characters are not allowed. Avoid inputting whitespaces.')" onchange="try{setCustomValidity('')}catch(e){}" oninput="setCustomValidity(' ')" value="<?php echo $inspector['inspector_midname'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="d-md-flex align-items-center justify-content-center flex-gap">
                                <div class="col col-md-6 p-1 form-group flex-md-grow-1">
                                    ...
                                    <input type="text" name="inspector_lastname" id="inspector-lastname" class="form-control p-4" id="exampleInputOwnerName" aria-describedby="inspectorNameHelp" placeholder="Enter Last Name..." value="<?php echo $lastname ?>" required>
                                </div>

                                <div class="col col-md-6 p-1 form-group flex-md-grow-1">
                                    <label for="inspector-suffix">Suffix <small class="font-italic"> (i.e. Sr., Jr., II, III) </small></label>
                                    <input type="text" name="inspector_suffix" id="inspector-suffix" class="form-control p-4" id="exampleInputOwnerName" aria-describedby="inspectorNameHelp" placeholder="Enter Suffix Name..." pattern="[a-zA-z .]+" oninvalid="this.setCustomValidity('Numbers and Special Characters are not allowed. Avoid inputting whitespaces.')" onchange="try{setCustomValidity('')}catch(e){}" oninput="setCustomValidity(' ')" maxlength="7" value="<?php echo $suffix ?>">
                                </div>
                            </div>
                            ...
                            <div class="d-md-flex align-items-center justify-content-center flex-gap">
                                <div class="col col-md-6 p-1 form-group flex-md-grow-1">
                                    ...
                                    <input type="text" name="contact_number" class="form-control p-4" id="contact-number" aria-describedby="contactnoHelp" placeholder="Enter Contact Number..." maxlength="11" pattern="^(09)\d{9}$" oninvalid="this.setCustomValidity('Characters are not allowed. 11 digit numnber starting with 09')" onchange="try{setCustomValidity('')}catch(e){}" oninput="setCustomValidity(' ')" value="<?php echo $inspector['contact_number'] ?>" required>
                                </div>

                                <div class="col col-md-6 p-1 form-group flex-md-grow-1">
                                    <label for="email">Email <span class="text-danger">*</span> <small class="font-italic">(i.e. sample@gmail.com)</small>
                                    </label>
                                    <input type="email" name="email" class="form-control p-4" id="email" aria-describedby="contactnoHelp" placeholder="Enter Email Address..." pattern="[A-Za-z0-9-._]+@[A-Za-z0-9.-_]+\.[a-zA-Z]{2,}" value="<?php echo $inspector['email'] ?>" required>
                                </div>
                            </div>
