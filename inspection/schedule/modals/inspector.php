            ...
            <div class="modal-body">
                <table class="table table-borderless d-flex flex-column justify-content-center" id="inspectorModalTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr class="d-flex justify-content-between align-inspectors-center border-bottom py-1 select-schedule-inspector" data-inspector-id="<?php echo $inspector['inspector_id'] ?>">
