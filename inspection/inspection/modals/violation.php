<!-- Logout Modal-->
<div class="modal fade" id="violation-list" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
            ...
            <div class="modal-body">
                <table class="d-flex justify-content-center">
                    ...
                    <tbody class="w-100">
                        ...
                        <tr class="d-flex justify-content-between align-violations-center border-bottom py-1 select-violation"
                            data-violation-id="<?php echo $violation['violation_id']?>">
