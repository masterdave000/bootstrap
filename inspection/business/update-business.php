                ...
                <div class="card card-body o-hidden shadow-lg p-4">
                    ...
                    <div class="d-flex flex-column justify-content-center col-lg-12">
                        ...
                        <form action="./controller/update.php" method="POST" class="user" enctype="multipart/form-data">
                            ...
                            <div class="col col-12 p-0 form-group" id="occupancy-group-container">
                                <label for="occupancy-group">Group <span class="text-danger">*</span>
                                </label>
                                <input type="text" name="occupancy_group" class="form-control p-4" id="occupancy-group" value="<?= $business['occupancy_group'] ?>" required readonly>
                            </div>

                            <input type="hidden" name="occupancy_classification_id" id="occupancy-classification-id" value="<?= $business['occupancy_classification_id'] ?>">
