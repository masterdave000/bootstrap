            ...
            <div class="card shadow mb-4">
                ...
                <div class="d-flex align-items-center justify-content-between card-header">
                    ...
                    <?php if ($role === 'Administrator') : ?>
                        <a href="./add-business.php" class="btn btn-primary d-flex justify-content-center align-items-center">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr class="d-flex justify-content-between align-items-center border-bottom py-1">
                                        <td class="p-0 m-0">
                                            <a href="view-business.php?bus_id=<?php echo $business['bus_id'] ?>" class="d-flex flex-row align-items-center justify-content-center text-decoration-none text-gray-700 flex-gap" href="./view-business.php?bus_id=<?php $business['bus_id'] ?>">
                                                <div class="image-container img-fluid">
                                                    <img src="./images/<?php echo $business['bus_img_url'] ?? 'no-image.png' ?>" alt="inspector-image" class="img-fluid rounded-circle" />
                                                </div>
                                        ...
                                        <td class="d-flex justify-content-end">
                                            ...
                                            <?php if ($role === 'Administrator') : ?>
                                                ...
                                                <a href="./update-business.php?bus_id=<?php echo $business['bus_id'] ?>" class="btn btn-info mr-2 text-center d-flex align-items-center">
                                                    <i class="fa fa-pencil-square mr-1" aria-hidden="true"></i>
                                                    <span class="d-none d-lg-inline">Edit</span>
                                                </a>

                                                <a href="#" data-bs-toggle="modal" data-bs-target="#deleteModal-<?php echo $business['bus_id'] ?>" class="btn btn-danger d-flex justify-content-center align-items-center">
