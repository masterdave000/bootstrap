<!-- Logout Modal-->
<div class="modal fade" id="deleteModal-<?php echo $owner['owner_id']?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="./controller/delete.php" method="POST">
                <div class="modal-body">Select "Delete" below if you are ready to delete the owner profile.
