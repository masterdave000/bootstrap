                        ...
                        <form action="./controller/update.php" method="POST" class="user" enctype="multipart/form-data">
                            ...
                            <div class="d-md-flex align-items-center justify-content-center flex-gap">
                                ...
                                <div class="col col-md-6 p-1 form-group flex-md-grow-1">
                                    ...
                                    <input type="text" name="owner_midname" id="owner-midname" class="form-control p-4" id="exampleInputOwnerName" aria-describedby="ownerNameHelp" placeholder="Enter Middle Name..." pattern="[a-zA-z -.ñÑ]+" oninvalid="this.setCustomValidity('Numbers and Special Characters are not allowed. Avoid inputting whitespaces.')" onchange="try{setCustomValidity('')}catch(e){}" oninput="setCustomValidity(' ')" value="<?php echo $owner['owner_midname'] ?>">
                                </div>
                            </div>
                            ...
                            <div class="d-md-flex align-items-center justify-content-center flex-gap">
                                <div class="col col-md-6 p-1 form-group flex-md-grow-1">
                                    ...
                                    <input type="text" name="owner_lastname" id="owner-lastname" class="form-control p-4" id="exampleInputOwnerName" aria-describedby="ownerNameHelp" placeholder="Enter Last Name..." value="<?php echo $lastname ?>" required>
                                </div>

                                <div class="col col-md-6 p-1 form-group flex-md-grow-1">
                                    <label for="owner-suffix">Suffix <small class="font-italic"> (i.e. Sr., Jr., II, III) </small></label>
                                    <input type="text" name="owner_suffix" id="owner-suffix" class="form-control p-4" id="exampleInputOwnerName" aria-describedby="ownerNameHelp" placeholder="Enter Suffix Name..." pattern="[a-zA-z .]+" oninvalid="this.setCustomValidity('Numbers and Special Characters are not allowed. Avoid inputting whitespaces.')" onchange="try{setCustomValidity('')}catch(e){}" oninput="setCustomValidity(' ')" maxlength="7" value="<?php echo $suffix ?>">
                                </div>
                            </div>
                            ...
                            <div class="d-md-flex align-items-center justify-content-center flex-gap">
                                <div class="col col-md-6 p-1 form-group flex-md-grow-1">
                                    ...
                                    <input type="text" name="contact_number" class="form-control p-4" id="contact-number" aria-describedby="contactnoHelp" placeholder="Enter Contact Number..." maxlength="11" pattern="^(09)\d{9}$" oninvalid="this.setCustomValidity('Characters are not allowed. 11 digit numnber starting with 09')" onchange="try{setCustomValidity('')}catch(e){}" oninput="setCustomValidity(' ')" value="<?php echo $owner['contact_number'] ?>" required>
                                </div>
