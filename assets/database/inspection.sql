...
CREATE TABLE annual_inspection_certificate (
    ...
    occupancy_no varchar(50) NULL DEFAULT NULL,
...
SELECT i.inspection_id, b.bus_id, o.owner_id, il.item_id, iins.inspector_id, o.owner_firstname, o.owner_midname, o.owner_lastname, o.owner_suffix, b.bus_name, 
